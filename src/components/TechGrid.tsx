...
const getIcon = (name: string) => {
  ...
  if (normName === "next.js") {
    return (
      ...
      >
        <path
          d="M12 0a12 12 0 1 0 12 12A12 12 0 0 0 12 0zm5.17 17.58l-5.69-7.25V17H10V7h1.48l5.69 7.25V7h1.48v10.58zM12 7a5 5 0 1 1-5 5 5 5 0 0 1 5-5z"
          opacity="0.15"
        />
  ...
  if (
    normName.includes("framer motion") ||
    normName.includes("motion choreography")
  ) {
    return (
      <svg
        viewBox="0 0 24 24"
