...
export function ContactForm() {
  ...
  return (
    <div
      className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-14 bg-[#0a0a0a] rounded-none border border-primary/10 p-6 sm:p-10 backdrop-blur-md"
      ...
      <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
        <div>
          ...
          <p className="font-sans text-sm text-accent leading-relaxed mb-6 font-light">
            Whether you have a specific system spec in mind, want to inquire
            about contract availability, or simply talk visual math
            concepts—fill down the contact parameters.
          </p>
          ...
          <div className="space-y-4 font-mono text-xs">
            <div className="flex items-center gap-3 text-neutral-400">
              ...
              <a
                href="mailto:alexander.vance@designer.io"
            ...
            <div className="flex items-center gap-3 text-neutral-400">
              <span className="text-primary font-bold">Phone no:</span>
            ...
            {configStatus.isConfigured ? (
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-neutral-500 font-sans leading-relaxed">
                  Provide{" "}
                  <code className="font-mono text-neutral-400 bg-neutral-900 px-1 rounded">
                    VITE_SUPABASE_URL
                  </code>{" "}
                  in secrets panel to enable real database ingestion.
                </p>
              </div>
            )}
          </div>
        ...
        >
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="text-xs">
                  ...
                  <p className="text-accent leading-relaxed">
                    Thank you, your communication has been saved.{" "}
                    {isDemoMode ? (
                      <span className="italic block mt-1 text-primary/80 font-mono">
                        (Demo Mode: Written to browser localStorage because
                        Supabase variables are pending)
                      </span>
                    ) : (
            ...
            {submitStatus === "error" && (
              ...
              >
                ...
                <div className="text-xs">
                  <h4 className="font-bold text-red-200 mb-1">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label
                htmlFor="input-name"
                className="block font-mono text-[10px] uppercase text-neutral-400 tracking-wider mb-2"
              >
                Your Identity / Name
              </label>
              <input
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label
                  htmlFor="input-email"
                  className="block font-mono text-[10px] uppercase text-neutral-400 tracking-wider"
                >
                  Email Address
                </label>
                {emailError && (
                  <span className="font-mono text-[10px] text-red-400 animate-pulse">
                    {emailError}
                  </span>
                )}
              </div>
